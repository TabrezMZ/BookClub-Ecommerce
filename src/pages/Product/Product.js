...
export const Product = () => {
    ...
    const { initialProducts ,selectRating, selectPrice,categoryType,sorttype} = productState
    ...
    ).filter((product) => categoryType.length > 0 ? categoryType.includes(product.category) : product).filter((product) => product.price <= selectPrice)
